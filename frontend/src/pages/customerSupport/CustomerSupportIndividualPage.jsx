...
export default function CustomerSupportIndividualPage() {
  ...
  const toggleSelectAll = () => {
    const ids = filteredBookings.map(r => r.id)
    ...
    <div style={{ minHeight: '100vh', background: COLORS.bgPage, padding: '32px 24px' }}>
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', gap: 14, flexWrap: 'wrap', alignItems: 'flex-end' }}>
          ...
          {/* ── 3. AWB input — leftmost, mutually exclusive with client/date ── */}
          <div style={{ flex: '1 1 160px', minWidth: 150 }}>
            ...
            <input
              ...
              onChange={e => {
                ...
                // Typing an AWB clears client + date so search is unambiguous
